<template>
    <div class="login">
        <img src="@/assets/images/background-logo.png" alt="" class="background-logo" />
            ...
            <ValidationObserver v-slot="{ handleSubmit }" slim>
                <form class="form" onsubmit="event.preventDefault()">
                    ...
                    <ValidationProvider v-slot="{ errors }" mode="passive" vid="password" :name="$t('password')" rules="required|min:8">
                        <ErrorTooltip field-name="password" :errors="errors">
                            <input
                                ...
                                v-focus
                                :class="[!profilesClassifiedByNetworkType ? 'un_click' : '', 'form-input large']"
                    ...
                    <div class="mt-1 flex justify-between">
                        <div>
                            Hint:
                            <span v-if="!!getPasswordHint().length" class="prompt pointer" @click="formItems.hasHint = !formItems.hasHint">
                                {{ $t('password_hint') }}
                            </span>
                        </div>
                    ...
                    <Button
                        ...
                        class="button primary large w-full mt-3.5"
    ...
    <!-- <div class="login-profile-wrapper relative">
